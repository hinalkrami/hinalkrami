    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><a href="Category-Form.php" class="bi bi-house-door fs-6"> Category Form</a></li>
        </ul>
      </div>
      <div class="row">
            ...
            <table class="table table-hover">
              ...
              <?php
                    ...
                    while($data=mysqli_fetch_array($q))
                    {
                        ...
                        echo "<td> <a href='Category-Edit.php?eid={$data['category_id']}'> Edit </a>|<a href='Category-Table.php?did={$data['category_id']}' onclick='return check();'> Delete </a> </td>";
                        echo "</tr>";
                    }
                ?>
              </tbody>
