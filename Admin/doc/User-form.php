...
if($_POST)
{
   ...
   $q=mysqli_query($connection,"insert into tbl_user(user_name,user_email,user_password,user_contact,user_address)
            ...
            <div class="tile-body">
              <form class="form-horizontal" method="post" id="userform">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8" type="email" placeholder="Enter email email" name="txt2" required/>
                  </div>
                </div>
                <div class="mb-3 row">
                  <label class="form-label col-md-3">Password</label>
                  <div class="col-md-8">
                    <input type="password" class="form-control" rows="4" placeholder="Enter your password" name="txt3" required/>
                  </div>
                </div>
                <div class="mb-3 row">
                  <label class="form-label col-md-3">Contact</label>
                  <div class="col-md-8">
                    <input type="text" class="form-control" rows="4" placeholder="Enter your Contact no." name="txt4" required/>
                  </div>
                </div>
                <div class="mb-3 row">
                  <label class="form-label col-md-3">Address</label>
                  <div class="col-md-8">
                    <textarea class="form-control" name="txt5" placeholder="Enter your address" required></textarea>
                  </div>
                </div>
                <div class="mb-3 row">
                      ...
                      <div class="tile-footer">
                        <div class="row">
                          <div class="col-md-8 col-md-offset-20">
                            ...
                            <button class="btn btn-success"><a href="user-table.php" id="link">View</a></button>   
                          </div>
                        </div>
                      </div>
                    </div>
