    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><a href="Order_Details-Form.php" class="bi bi-house-door fs-6"> Order Form</a></li>
        </ul>
      </div>
      <div class="row">
          ...
          <div class="tile">
            ...
            <table class="table table-hover">
              ...
              <?php
                    ...
                    {
                      $did=$_GET['did'];
                      $dq=mysqli_query($connection,"DELETE FROM tbl_order_details WHERE order_details_id='{$did}'");
                      if($dq)
                      {
                    ...
                    {
                      $pq=mysqli_query($connection,"SELECT * FROM tbl_product WHERE pro_id={$data['pro_id']}");
                      $pdata=mysqli_fetch_array($pq);
                        ...
                        echo "<td> {$data['pro_qty']} </td>";
                        echo "<td> {$data['pro_price']} </td>";
                        
                        echo "<td><a href='Order_Details-Table.php?did={$data['order_details_id']}' onclick='return check();'> Delete </a> </td>";
                        echo "</tr>";
                    }
                ?>
              </tbody>
