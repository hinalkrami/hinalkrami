...
include 'Firstlogin.php';
 ...
 if(!isset($_GET['eid']))
 {
    header("localhost:Cart-Table.php");
 }
 $sq=mysqli_query($connection,"SELECT * FROM tbl_cart where cart_id='{$eid}'");
 ...
 if($_POST)
  {
    ...
    $q=mysqli_query($connection,"UPDATE tbl_cart SET product_id='{$product_id}',user_id='{$user_id}',product_qty='{$product_qty}',product_price='{$product_price}' WHERE cart_id='{$eid}'");
  }
?>
<html lang="en">
  <head>
			...
			if($_POST)
				{
                  ...
                  <button class='btn-close' type='button' data-bs-dismiss='alert'></button> Record Inserted.  
                    </div><script>window.location=Cart-Table.php;</script>";
				}
		?>
          <div class="tile">
            ...
            <div class="tile-body">
              <form class="form-horizontal" id="cartedit" method="post">
              <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-md-8">
                    ...
                    echo "<option value=''>Select</option>";
                    while($urow=mysqli_fetch_array($sq))
                    {
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8" type="text" placeholder="Enter Order quantity" value="<?php echo $row['product_qty'] ?>" name="txt3" required>
                  </div>
                </div>
                <div class="mb-3 row">
                  <label class="form-label col-md-3"> Product Price</label>
                  <div class="col-md-8">
                    <input type="text" class="form-control" rows="4" placeholder="Enter product price" value="<?php echo $row['product_price'] ?>" name="txt4" required>
                  </div>
                </div>
