    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><a href="Feedback-Form.php" class="bi bi-house-door fs-6"> Feedback Form</a></li>
        </ul>
      </div>
      <div class="row">
            ...
            <table class="table table-hover">
              ...
              <?php
                    ...
                    while($data=mysqli_fetch_array($q))
                    {
                        ...
                        echo "<td> <a href='Feedback-Table.php?did={$data['feedback_id']}' onclick='return check();'> Delete </a> </td>";
                        echo "</tr>";
                    }
                ?>
              </tbody>
